...
function World ({ game, dragging, onResult, sound, hitLabel, onReady }) {
...
export const Scene = memo(function Scene (props) {
  return <Canvas shadows={{ type: THREE.PCFShadowMap }} dpr={[1, 1.75]} camera={{ position: [0, 1, 9], fov: 48 }}><World {...props} /></Canvas>
})
